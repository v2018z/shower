/*! This file is created by jax.xie */
...
/***/ function(module, exports, __webpack_require__) {
	...
	Shower = (function() {
	  function Shower(options) {
	    var opt;
	    opt = {
	      'speed': 10,
	      'items': []
	    };
	    this.opt = _.extend({}, opt, options);
	    this.initialState();
	    this.start();
	  }

	  Shower.prototype.random = function(min, max) {
	    return Math.floor(Math.random() * (1 + max - min) + min);
	  };

	  Shower.prototype.move = function() {
	    var random, speed, tl;
	    random = this.random;
	    speed = this.opt.speed;
	    this.tl = tl = new TimelineMax({
	      repeat: -1
	    });
	    return this.dots.each(function() {
	      return tl.add(TweenMax.fromTo(this, speed, {
	        left: random(0, 100) + "%",
	        top: random(0, 100) + "%",
	        z: random(-725, 600),
	        opacity: Math.random()
	  ...
	  Shower.prototype.initialState = function() {
	    return this.state = {
	      'pause': false
	    };
	  };

	  Shower.prototype.regiterEvent = function() {
	    this.state;
	    return $(".container").on('click', (function(_this) {
	      return function() {
	        ...
	        return _this.state.pause = !_this.state.pause;
	      };
	    })(this));
	  };

	  Shower.prototype.render = function() {
	    var html, i, items;
	    ...
	    return this.dots = $(html).appendTo(this.container);
	  };

	  Shower.prototype.start = function() {
	    this.render();
	    this.regiterEvent();
	    return this.move();
	  };
